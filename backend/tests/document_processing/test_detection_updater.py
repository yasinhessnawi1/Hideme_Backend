...
class TestDetectionResultUpdater(unittest.IsolatedAsyncioTestCase):
    ...
    def setUp(self):
                ...
                "pages": [
                    {
                        "page": 1,
                        "sensitive": [
                            {"entity_type": "TEST", "original_text": "test example"}
                        ],
                    }
                ]
            },
        ...
        self.updater = DetectionResultUpdater(
            self.extracted_data, self.detection_result
        )
    ...
    def test_get_original_page_found(self):
        ...
        self.assertEqual(
            result, {"page": 1, "words": [{"text": "test"}, {"text": "example"}]}
        )
    ...
    def test_process_sensitive_entities_split_with_bbox(self):
        entities = [
            {"original_text": "Confidential Report 2023", "start": 0, "end": 20}
        ]
    ...
    def test_append_updated_entities(self):
        ...
        self.updater._build_updated_entity = MagicMock(
            return_value={
    ...
    def test_reconstruct_page_text_basic(self):
        ...
        full_text, mapping = DetectionResultUpdater._reconstruct_page_text(
            page_data, page_num
        )
    ...
    def test_get_original_page_next_empty(self):
        self.updater.extracted_data = {
            "pages": [{"page": 2, "words": [{"text": "test"}]}]
        }
