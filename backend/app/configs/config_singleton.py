...
def _load_config_from_env() -> None:
    ...
    _config['default_language'] = os.getenv("DEFAULT_LANGUAGE", "nb")  # Changed default to Norwegian
    _config['spacy_model'] = os.getenv("SPACY_MODEL", "nb_core_news_lg")  # Norwegian model
