...
ERROR_LOG_PATH = os.environ.get("ERROR_LOG_PATH", "app/logs/error_logs/detailed_errors.log")
...
ENABLE_DISTRIBUTED_TRACING = os.environ.get("ENABLE_DISTRIBUTED_TRACING", "false").lower() == "true"
