...
def generate_evaluation_tables(all_model_data):
    ...
    output += "## Methodology\n"
    output += "This evaluation compares different entity recognition models using manual redaction as a baseline.\n"
...
def main():
    ...
    gemini_files = [
        r"C:\Users\anwar\final_backend_2\traning\hideme-models-labeling\gemini_labeling.json",
        r"C:\Users\anwar\final_backend_2\traning\hideme-models-labeling\gemini_labeling_2.json"
    ]
    ...
    presidio_files = [
        r"C:\Users\anwar\final_backend_2\traning\hideme-models-labeling\presidio_labeling.json",
        r"C:\Users\anwar\final_backend_2\traning\hideme-models-labeling\presidio_labeling_2.json"
    ]
    ...
    manual_files = [
        "manuell_redacted.json",
        "manuell_redacted_2.json",
        "manuell_redacted_3.json"
    ]
