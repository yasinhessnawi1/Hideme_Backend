...
API_ENDPOINT = "http://localhost:8000/ai/detect"
OUTPUT_FILE = "gemini_labeling.json"
REQUEST_DELAY = 4  # seconds
MAX_FILES = 50  # maximum number of files to process
GEMINI_API_KEY = "AIzaSyAPP8Fz2FHoGcLdc-1HbFoE8K8X4RzJBYE"
    ...
    for i, pdf_path in enumerate(pdf_files_to_process):
        ...
        try:
            ...
            with open(pdf_path, 'rb') as pdf_file:
                ...
                # Properly format the file for upload
                files = {
                    'file': (os.path.basename(pdf_path), pdf_file, 'application/pdf')
                }

                # Send the file to the API with headers and files parameter
