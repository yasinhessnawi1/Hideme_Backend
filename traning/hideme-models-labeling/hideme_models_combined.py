...
API_ENDPOINT = "http://localhost:8000/batch/hybrid_detect"
OUTPUT_FILE = "gemini_gliner_presidio.json"
REQUEST_DELAY = 4  # seconds
MAX_FILES = 50 # maximum number of files to process
    ...
    for i, pdf_path in enumerate(pdf_files_to_process):
        ...
        try:
            ...
            with open(pdf_path, 'rb') as pdf_file:
                ...
                # Key change: Use 'files' instead of 'file' as the field name
                files = {'files': (os.path.basename(pdf_path), pdf_file, 'application/pdf')}
                data = {
                    'requested_entities': '["ALL_GLINER", "ALL_GEMINI", "ALL_PRESIDIO"]',
                    'use_gliner': 'True',
                    'use_gemini': 'True'
                }
